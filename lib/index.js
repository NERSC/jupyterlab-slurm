...
var SlurmWidget = /** @class */ (function (_super) {
    ...
    SlurmWidget.prototype._reload_queue_table = function () {
        this._reload_data_table($('#queue').DataTable());
        console.log('searchable');
    };
    ;
    SlurmWidget.prototype._set_headers = function (xhttp) {
...
function activate(app, palette, restorer) {
    ...
    palette.addItem({ command: command, category: 'HPC Tools' });
    // Track and restore the widget state
    var tracker = new apputils_1.InstanceTracker({ namespace: 'hpc' });
    restorer.restore(tracker, {
        command: command,
        args: function () { return coreutils_2.JSONExt.emptyObject; },
        name: function () { return 'hpc'; }
    });
} // activate
/**
